...
public class OverloadingDemo {
	public static void main(String[] args) {
		System.out.println("_____________________Constructor overloading________________________");
		Point p=new Point();
		...
		System.out.println("_____________________method overloading_____________________________");
